...
select * from tabSME_BO_and_Plan bp inner join temp_sme_SABCFtss on (bp.name = tss.id)

update tabSME_BO_and_Plan bp inner join temp_sme_SABCFtss on (bp.name = tss.id)
